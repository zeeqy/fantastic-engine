...
#api = API(num_cluster=10, device=torch.device("cuda:0" if torch.cuda.is_available() else "cpu"), iprint=2)
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        #loss = api.loss_func(outputs, targets, None)
...
history = np.savez(args.dataset + '_' + str(args.valid_size) + '_standard_' + str(args.exp_num) + '_history', train_loss=train_loss_his, valid_loss=valid_loss_his, test_loss=test_loss_his,
