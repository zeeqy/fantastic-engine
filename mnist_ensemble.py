...
def main():
	...
	optimizer_standard = optim.Adam(model_standard.parameters(), lr=args.lr, weight_decay=5e-4)
	...
	optimizer_reweight = optim.Adam(model_reweight.parameters(), lr=args.lr, weight_decay=5e-4)
